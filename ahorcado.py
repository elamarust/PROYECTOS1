...
def ahorcado():
    ...
    while len(letras_por_adivinar) > 0 and vidas > 0:
        ...
        # que ya se han ingresado, se añade la letra al 
        # conjunto de letras ingresadas.
    ...
    # El juego llega a esta línea cuando se adivinan todas 
    # las letras de la palabra o cuando se agotan las vidas # del jugador.
    if vidas == 0:
        print(vidas_diccionario_visual[vidas])
